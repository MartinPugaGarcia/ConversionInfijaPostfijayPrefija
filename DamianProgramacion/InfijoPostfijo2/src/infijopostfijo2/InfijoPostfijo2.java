...
public class InfijoPostfijo2 {
    ...
    public static void main(String[] args) {
        ...
        //Agregar el array a la pila de entrada (E)
        ...
        try{
            ...
            //Eliminacion de impurezas en las expresiones algebraicas
    ...
    private static String depurar (String s) {
        s = s.replaceAll("\\s+", "");//Eliminar espacios en blanco
        s = "(" + s + ")";
        String simbols = "+-*/()";
        String str = "";
